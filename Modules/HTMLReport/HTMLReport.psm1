...
"<td align=$Align bgcolor=$CellBGColor>$Cell</td>" | Out-File -Append -FilePath $OutFile
...
Function WriteReportFooter
    ...
    <tr><td>Written By: <A href='mailto:$WrittenBy'>Paul Kell</a></td><td>Last Modified: $LastModified</td></tr>
...
Function SendEmailFile
    ...
    #-Cc $CC
    Send-MailMessage -SmtpServer $SMTPServer -From $SMTPLogin -Subject $Subject -To $To -CC $CC -UseSsl -port $SMTPPort -Attachments $Attachment -BodyAsHtml -Body $Body -Credential $SMTPCreds
    }
